...
public static void menuPrincipal(){
    ...
    System.out.println("╠═════════════════════════════════════════╣");
    System.out.println("║     1 - Entrar menu professor           ║");
    System.out.println("║     2 - Entrar menu coordenador         ║");
    System.out.println("╚═════════════════════════════════════════╝");
...
public static void menuCoordenador(){
    ...
    System.out.println("Digite a senha do Menu do coodernador:");
    opcao = entrada.nextInt();
    if(opcao == db.getSenhaCoordenador()){
        System.out.println("Bem-Vindo a Menu do Coodernador!");
        System.out.println("");
    }else{
        menuPrincipal();
    }
...
public static void menuProfessor(){
  DataBase db = DataBase.getInstance();
    ...
    System.out.println("Digite a senha do Menu do professor:");
    opcao = entrada.nextInt();
    if(opcao == db.getSenhaProfessor()){
        System.out.println("Bem-Vindo a Menu do Professor!");
        System.out.println("");
    }else{
        menuPrincipal();
    }
